        ...
        <?php
          ...
          foreach ($clientes as $key => $value) {
            ...
            echo '<tr>
                    ...
                    <td class="text-uppercase"><b>'.$value["nombre"].' '.$value["apellido"].'</b></td>

                    <td>'.$value["documento"].'</td>

                    <td class="text-uppercase"><i class="fa fa-map-marker"></i> '.$value["direccion"].'<br>
                    <i class="fa fa-phone"></i> '.$value["telefono"].'<br>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-map-marker"></i><b> Apellido: </b></span> 
