              ...
              <div class="box">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <option class="text-uppercase" value="<?php echo $cliente["id"]; ?>"><?php echo $cliente["documento"]." - ".$cliente["nombre"]." ".$cliente["apellido"]; ?></option>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-user"></i><b> Nombre: </b></span> 
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-user"></i><b> Apellido: </b></span> 
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-key"></i><b> Documento ID: </b></span> 
