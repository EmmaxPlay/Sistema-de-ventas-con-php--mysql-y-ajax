          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-user"></i><b> Proveedor: </b></span> 
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-key"></i><b> Registro: </b></span> 
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-phone"></i><b> Teléfono: </b></span> 

                <input type="text" class="form-control input-lg" name="nuevoTelefono" placeholder="Ingresar teléfono" data-inputmask="'mask':'+99(999) 999-9999'" data-mask>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-phone"></i><b> Teléfono 2: </b></span> 

                <input type="text" class="form-control input-lg" name="nuevoTelefono2" placeholder="Ingresar teléfono 2" data-inputmask="'mask':'+99(999) 999-9999'" data-mask>
...
<!-- ENTRADA PARA EL TELÉFONO3 -->
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-phone"></i><b> Teléfono 3: </b></span> 

                <input type="text" class="form-control input-lg" name="nuevoTelefono3" placeholder="Ingresar teléfono 3" data-inputmask="'mask':'+99(999) 999-9999'" data-mask>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-instagram"></i><b> Instagram: </b></span> 
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <span class="input-group-addon"><i class="fa fa-whatsapp"></i><b> Whatsapp: </b></span> 

                <input type="text" class="form-control input-lg" name="nuevowhatsapp" placeholder="Ingresar whatsapp" data-inputmask="'mask':'+99(999) 999-9999'" data-mask>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarTelefono" id="editarTelefono" data-inputmask="'mask':'+99(999) 999-9999'" data-mask >
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarTelefono2" id="editarTelefono2" data-inputmask="'mask':'+99(999) 999-9999'" data-mask >
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarTelefono3" id="editarTelefono3" data-inputmask="'mask':'+99(999) 999-9999'" data-mask >
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarwhatsapp" id="editarwhatsapp" data-inputmask="'mask':'+99(999) 999-9999'" data-mask >
